...
class GavetaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('PIPR'),backgroundColor: Colors.green,),
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  new MaterialPageRoute(builder: (context) => new QuemSomosScreen()),
                );
              },
            )
            ,
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  new MaterialPageRoute(builder: (context) => new CultoScreen()),
                );
              },
            )
            , ListTile(
            ...
            ListTile(
              ...
              onTap: () {
                ...
                // ...
                // Then close the drawer
                const url = 'https://www.google.com/maps/place/Primeira+Igreja+Presbiteriana+de+Roraima/@2.8250649,-60.6740316,16.27z/data=!4m12!1m6!3m5!1s0x0:0x8b9f5b0ee29353b8!2sGaleria+vida!8m2!3d2.828348!4d-60.674752!3m4!1s0x8d93060cae68569b:0xde85d3da073d7615!8m2!3d2.8256367!4d-60.671183?hl=pt-BR';
                launch(url);
              },
            ),
            ListTile(
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  new MaterialPageRoute(builder: (context) => new AgendaScreen()),
                );
              },
            ),
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  new MaterialPageRoute(builder: (context) => new SociedadeScreen()),
                );
              },
            ),
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  new MaterialPageRoute(builder: (context) => new DocumentosScreen()),
                );
              },
            ),
            ListTile(
                  ...
                  Column(
                      children: [
                        ...
                        RaisedButton(
                            ...
                            color: Colors.white,
                            child:  Image.asset(
                                'assets/icons/facebook-like.jpeg'
                                ,width:60
                            ),
                            onPressed: () {
                        ...
                        ,RaisedButton(
                            color: Colors.white,
                            child: Image.asset('assets/icons/youtube.jpg',
                            width:60),
                            onPressed: () {
                              const url = 'https://www.youtube.com/user/piprrtv/videos/';
                              launch(url);
        ...
        children: [
          RaisedButton(
            onPressed: () {
              ...
              // the form is invalid.
              const url = 'http://www.monergismo.com/textos/catecismos/brevecatecismo_westminster.htm';
              launch(url);
            },
            child:
              Text('Breve Catecismo de Westminister')
          )
          , RaisedButton(
              onPressed: () {
                // Validate will return true if the form is valid, or false if
                // the form is invalid.
                const url = 'http://www.monergismo.com/textos/catecismos/catecismomaior_westminster.htm';
                launch(url);
              },
              child:
              Text('Catecismo Maior de Westminister')
          ),
          RaisedButton(
              onPressed: () {
                // Validate will return true if the form is valid, or false if
                // the form is invalid.
                const url = 'http://www.executivaipb.com.br/arquivos/confissao_de_westminster.pdf';
                launch(url);
              },
              child:
              Text('Confissão de Fé Westminister')
          )
        ]
      )
    );
